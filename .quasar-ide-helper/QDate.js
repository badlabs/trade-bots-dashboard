...
export default {
  ...
  props: {
     ...
     * @param {{year : Number, month : Number, day : Number, from : {year : Number, month : Number, day : Number}, to : {year : Number, month : Number, day : Number}}} details Object of properties on the new model 
     */      
