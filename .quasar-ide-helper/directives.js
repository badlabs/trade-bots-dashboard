...
/*
 * @param {{group : String, name : String, model : String, duration : Number, delay : Number, easing : String, fill : String, classes : String, style : String|Object, resize : Boolean, useCSS : Boolean, hideFromClone : Boolean, keepToClone : Boolean, tween : Boolean, tweenFromOpacity : Number, tweenToOpacity : Number, waitFor : Number|String|Promise, onEnd : Function}|*} Configuration object or trigger value
 */
Vue.directive('Morph', {})
