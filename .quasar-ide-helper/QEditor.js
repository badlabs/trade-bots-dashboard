...
export default {
  ...
  props: {
     ...
     * @type {{label : String, tip : String, htmlTip : String, icon : String, key : Number, handler : Function, cmd : String, param : String, disable : Boolean|Function, type : |'no-state', fixedLabel : Boolean, fixedIcon : Boolean, highlight : Boolean}}
     */
    definitions: {
      type: Object,
    },
